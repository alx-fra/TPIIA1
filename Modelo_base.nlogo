...
breed[Leoes Leao]
turtles-own [energia];
globals [energialeao energiaHiena energia-media-leoes energia-media-hienas  hiena-killcount leao-killcount tempo sobr-l sobr-h]
Hienas-own [nvl]
...
to setup-patches
  ...
  ask n-of nAzul patches with [pcolor = black] [set pcolor blue] ;entre 0-5 azuis
...
@#$#@#$#@
<experiments>
  <experiment name="modeloBase" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>tempo</metric>
